    ...
    */
    ...
    function wtn_internal_settings()
    {
        ...
        if ( isset( $_POST['updateGeneralSettings'] ) ) {
            ...
            if ( !isset( $_POST['wtn_general_content_nonce_field'] ) || !wp_verify_nonce( $_POST['wtn_general_content_nonce_field'], 'wtn_general_content_action' ) ) {
    ...
    function wtn_featured_settings()
    {
        ...
        if ( isset( $_POST['updateGeneralSettings'] ) ) {
            ...
            if ( !isset( $_POST['wtn_featured_content_nonce_field'] ) || !wp_verify_nonce( $_POST['wtn_featured_content_nonce_field'], 'wtn_featured_content_action' ) ) {
                print 'Sorry, your nonce did not verify.';
                exit;
            } else {
    ...
    function wtn_ticker_settings()
    {
        ...
        if ( isset( $_POST['updateTickerContentSettings'] ) ) {
            ...
            if ( !isset( $_POST['wtn_ticker_content_nonce_field'] ) || !wp_verify_nonce( $_POST['wtn_ticker_content_nonce_field'], 'wtn_ticker_content_action' ) ) {
                print 'Sorry, your nonce did not verify.';
                exit;
            } else {
        ...
        if ( isset( $_POST['updateTickerStylesSettings'] ) ) {
            ...
            if ( !isset( $_POST['wtn_ticker_style_nonce_field'] ) || !wp_verify_nonce( $_POST['wtn_ticker_style_nonce_field'], 'wtn_ticker_style_action' ) ) {
                print 'Sorry, your nonce did not verify.';
                exit;
            } else {
    ...
    function wtn_general_settings()
    {
        ...
        if ( isset( $_POST['updateGeneralSettings'] ) ) {
            ...
            if ( !isset( $_POST['wtn_int_general_nonce_field'] ) || !wp_verify_nonce( $_POST['wtn_int_general_nonce_field'], 'wtn_int_general_action' ) ) {
                print 'Sorry, your nonce did not verify.';
                exit;
            } else {
