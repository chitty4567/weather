...
<div id="wph-wrap-all" class="wrap wtn-settings-page">
    ...
    <div class="settings-banner">
        <h2><i class="fa fa-cogs" aria-hidden="true"></i>&nbsp;<?php _e('Featured News Settings', 'wp-top-news'); ?></h2>
    </div>
    ...
    <div class="wtn-wrap">
        ...
        <nav class="nav-tab-wrapper">
            <a href="?post_type=wtn_news&page=wtn-featured-settings&tab=general" class="nav-tab wtn-tab <?php if ( ( $tab === 'general' ) || ( $tab === '' ) ) { ?>wtn-tab-active<?php } ?>">
        ...
        <div class="wtn_personal_wrap wtn_personal_help" style="width: 75%; float: left;">
            ...
            <div class="tab-content">
                ...
                switch ( $tab ) {
                    ...
                    default:
						include_once 'partial/featured-general.php';
                        break;
                } 
                ?>
            </div>
